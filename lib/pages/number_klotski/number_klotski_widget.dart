...
class NumberKlotskiWidget extends StatefulWidget {
  const NumberKlotskiWidget({super.key});

  @override
  State<NumberKlotskiWidget> createState() => _NumberKlotskiWidgetState();
}

class _NumberKlotskiWidgetState extends State<NumberKlotskiWidget>
    with TickerProviderStateMixin {
  late NumberKlotskiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NumberKlotskiModel());
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 12.0, 16.0, 16.0),
                                      child: Text(
                                        '*Klotski 3x3 Puzzle includes sliding blocks from 1 to 8, and an empty space allowing the pieces to move. \n\n*Playing Klotski 3x3 Puzzle, you need to move 1 piece each time, till the number are restored in the order from 1 to 8.\n\n* Try to use as less moves and time as possible.',
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium,
                                      ).animateOnPageLoad(animationsMap[
